...
prx.types.applewatch_notification = {
	...
	,onDisplay: function(item,containerid) {
		...
		var _nameprops = prx.componentsHelper.getProp(item.nameProperties,'props-text');
